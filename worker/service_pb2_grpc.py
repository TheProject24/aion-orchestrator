...
class ModelOrchestratorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Predict = channel.unary_unary(
                '/aion.ModelOrchestrator/Predict',
...
def add_ModelOrchestratorServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'aion.ModelOrchestrator', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('aion.ModelOrchestrator', rpc_method_handlers)
